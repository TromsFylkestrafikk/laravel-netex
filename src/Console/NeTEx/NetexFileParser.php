...
/*          <destinationDisplays>
              <DestinationDisplay version="1" id="TRO:DestinationDisplay:29">
              <FrontText>Bardufoss vgs Rustadhøgda</FrontText>
              </DestinationDisplay>*/
            break;
...
//            $this->scheduledStopPoints[$id]['StopPointID'] = (int)$arr[0];
//            $this->scheduledStopPoints[$id]['ExtendedID'] = (int)$arr[1];
            break;
          ...
          case 'Notice':
/*          <notices>
              <Notice version="1" id="TRO:Notice:11">
                <Text>Bestilles innen kl.10:00 24.12 julaften</Text>
